...
**Evidence:** P001 detected: package.json version '0.1.0' does not match release version '0.0.2'

**Suggestion:** Ensure the version in your metadata matches the latest official release (0.0.2). Keeping these synchronized avoids confusion for users and improves reproducibility.

### [P017](https://w3id.org/rsmetacheck/catalog/#P017)
**Evidence:** P017 detected: codemeta.json and package.json version '0.0.2' does not match package.json version '0.1.0'
...
**Evidence:** W002 detected: metadata files dateModified '2026-03-19T00:00:00' is outdated compared to repository date '2026-07-06T09:30:39'

**Suggestion:** The data in the metadata file should be updated to be aligned with the date of the latest release (2026-07-06T09:30:39).
